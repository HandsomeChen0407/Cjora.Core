namespace Cjora.Core.Servers;

/// <summary>
/// 全局规范化结果
/// </summary>
[UnifyModel(typeof(CoreResult<>))]
public class CoreResultProvider : IUnifyResultProvider
{
    /// <summary>
    /// JWT 授权异常返回值
    /// </summary>
    ...
    /// <returns></returns>
    private static CoreResult<object> RESTfulResult(int statusCode, bool succeeded = default, object data = default, object errors = default)
    {
        //// 统一返回值脱敏处理
